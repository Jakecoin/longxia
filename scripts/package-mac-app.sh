...
# Build and bundle Longxia into a minimal .app we can open.
...
SPARKLE_FEED_URL="${SPARKLE_FEED_URL:-https://raw.githubusercontent.com/Jakecoin/longxia/main/appcast.xml}"
AUTO_CHECKS=true
