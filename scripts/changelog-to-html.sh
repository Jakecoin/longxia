...
if [[ -z "$version_content" ]]; then
  echo "<h2>Longxia $VERSION</h2>"
  echo "<p>Latest Longxia update.</p>"
  echo "<p><a href=\"https://github.com/Jakecoin/longxia/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
