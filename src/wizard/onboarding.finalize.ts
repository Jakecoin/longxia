...
export async function finalizeOnboardingWizard(
  ...
  await prompter.note(
    [
      ...
      "Docs: ./docs/concepts/agent-workspace.md",
    ].join("\n"),
    "Workspace backup",
  );

  await prompter.note(
    "Running agents on your computer is risky. Harden your setup: ./docs/gateway/security/index.md",
    "Security",
  );
  ...
  await prompter.note(
    'What now: ./docs/start/showcase.md',
    "What now",
  );
