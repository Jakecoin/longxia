...
Voice call extension source for **Longxia**.
...
Docs: `./docs/plugins/voice-call.md`
Fork policy: `./docs/design/network-boundary.md`

## Install (local dev)

Longxia disables runtime plugin installation. For local development, work from
the source tree or copy the extension into the local extensions directory.
