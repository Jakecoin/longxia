...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/Jakecoin/longxia") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/Jakecoin/longxia")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://github.com/Jakecoin/longxia")
                AboutLinkRow(icon: "book", title: "Docs", url: "https://github.com/Jakecoin/longxia/tree/main/docs")
            }
