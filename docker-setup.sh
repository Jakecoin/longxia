...
echo "Longxia disables Telegram, Discord, WhatsApp, and runtime plugin channels."
echo "Configure only approved built-in channels or local web access."
echo "Local docs: ./docs/channels/index.md"
...
if [[ -n "$SANDBOX_ENABLED" ]]; then
  ...
  if [[ "$sandbox_config_ok" == true ]]; then
    ...
    echo "Local docs: ./docs/design/network-boundary.md"
