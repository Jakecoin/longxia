# Contributing to the Longxia Threat Model

Thanks for helping make Longxia more secure. This threat model is a living document and we welcome contributions from anyone - you don't need to be a security expert.

## Ways to Contribute

### Add a Threat

Spotted an attack vector or risk we haven't covered? Open an issue or pull request in this repository and describe it in your own words. You don't need to know any frameworks or fill in every field - just describe the scenario.

**Helpful to include (but not required):**

- The attack scenario and how it could be exploited
- Which parts of Longxia are affected (CLI, gateway, channels, local tooling, etc.)
- How severe you think it is (low / medium / high / critical)
- Any links to related research, CVEs, or real-world examples

We'll handle the ATLAS mapping, threat IDs, and risk assessment during review. If you want to include those details, great - but it's not expected.

> **This is for adding to the threat model, not reporting live vulnerabilities.** If you've found an exploitable vulnerability, follow the private disclosure process in [../../SECURITY.md](../../SECURITY.md).
...
- [Longxia Threat Model](./THREAT-MODEL-ATLAS.md)

## Contact

- **Security vulnerabilities:** Follow the private process in [../../SECURITY.md](../../SECURITY.md)
- **Threat model questions:** Open an issue or PR in this repository
- **General discussion:** Keep it in maintainer-controlled project channels for this fork

## Recognition

Contributors to the threat model are recognized in the threat model acknowledgments and release notes for this fork.
