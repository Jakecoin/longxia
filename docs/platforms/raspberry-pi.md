---
summary: "Longxia on Raspberry Pi (budget self-hosted setup)"
read_when:
  - Setting up Longxia on a Raspberry Pi
  - Running Longxia on ARM devices
  - Building a cheap always-on personal AI
title: "Raspberry Pi"
---

# Longxia on Raspberry Pi
...
- Home automation hub
- Low-power, always-available local gateway
...
3. **Channels:** removed public messaging channels stay disabled in Longxia
