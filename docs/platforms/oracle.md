---
summary: "Longxia on Oracle Cloud (Always Free ARM template)"
read_when:
  - Setting up Longxia on Oracle Cloud
  - Looking for a low-cost ARM VPS template
title: "Oracle Cloud"
---

# Longxia on Oracle Cloud (OCI)
...
Keep this deployment focused on the Control UI, local docs, and bundled tools.
Do not re-enable removed public messaging channels or runtime plugin installs on
this host unless you are intentionally maintaining your own private fork.
