...
Longxia does not mirror or auto-install this community package. If you choose to
use it, vendor it from an internally approved source and install it with your own
registry policy.
...
- This is treated as an external community dependency.
- Longxia does not provide a public mirror, install button, or bundled copy for it.
- If your team needs it, pin a vetted internal source and document that separately.
