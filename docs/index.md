...
- If you **do nothing**, Longxia uses the bundled runtime with local Control UI access.
- If you want to lock it down further, start with gateway auth, loopback bind, and the sandbox/tool policy settings.
