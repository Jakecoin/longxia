...
Mattermost is not exposed as a runtime-installable integration in Longxia.
...
In Longxia, treat plugin metadata as internal build-time state only. See [Network Boundary](/design/network-boundary).
