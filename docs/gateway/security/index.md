...
4. Claim is not listed in [Out of Scope](../../../SECURITY.md#out-of-scope).
...
- In Longxia, do not expose runtime plugin installation to end users.
- Keep extension capability changes inside reviewed, build-time deployment updates.

Details: [Network Boundary](/design/network-boundary)
...
Found a vulnerability in Longxia? Please report responsibly:

1. Follow the private process in [../../../SECURITY.md](../../../SECURITY.md)
